// app/signup/page.tsx - OAUTH ONLY
'use client'
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Sign up with Google or GitHub to access automation resources.
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="p-4 bg-white rounded-lg shadow">
            <div className="text-tre1-teal font-bold">Free Tier</div>
            <div className="text-gray-600 text-sm">Access basic resources</div>
          </div>
          <div className="p-4 bg-white rounded-lg shadow">
            <div className="text-tre1-teal font-bold">PDF Library</div>
            <div className="text-gray-600 text-sm">Automation guides</div>
          </div>
          <div className="p-4 bg-white rounded-lg shadow">
            <div className="text-tre1-teal font-bold">Community</div>
            <div className="text-gray-600 text-sm">Join experts</div>
          </div>
        </div>
      </div>
    </div>
