// lib/resend.ts - COMPLETE FIXED VERSION
import { Resend } from 'resend'  // ✅ Import Resend class from the package

const resend = new Resend(process.env.RESEND_API_KEY)  // ✅ Create instance with capital R
